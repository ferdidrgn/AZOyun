        ...
        child: Column(children: [
          ...
          AnimatedContainer(
            ...
            child: Center(
              child: Text(
                _myDone
                    ? '✅ Deliğe girdi! Diğerleri bekleniyor...'
                    : _moving
                        ? '🎱 Top gidiyor...'
  ...
  void paint(Canvas canvas, Size s) {
    ...
    for (var i = 0; i < 10; i++) {
      if (i.isOdd) {
        canvas.drawRect(
            Rect.fromLTWH(
                0, s.height * i / 10, s.width, s.height / 10),
            stripe);
      }
    }
    ...
    for (final w in walls) {
      canvas.drawLine(
          Offset(w.a.dx * s.width, w.a.dy * s.height),
          Offset(w.b.dx * s.width, w.b.dy * s.height),
          wallPaint);
    }
