...
void main() async {
  ...
  await AdService.instance.initialize(); // reklamları başlat
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Banner için standart Scaffold kullan
      body: Container(
        decoration: const BoxDecoration(gradient: AZColors.gradPurple),
        child: SafeArea(
          bottom: false, // Banner için alt safe area'yı kapatma
          child: Column(children: [
            ...
            // ── Banner reklam — ana menü altında ──────────────────────────
